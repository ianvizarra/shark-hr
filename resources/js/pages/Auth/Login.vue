<template>
    <form class="max-w-lg bg-white rounded-lg shadow mx-auto p-8" @submit.prevent="submit">
        <h1 class="text-2xl text-teal-500 font-bold">Sign In To Your Account</h1>
        ...
        <button class="w-full bg-teal-800 hover:bg-teal-900 text-white text-sm font-semibold rounded focus:outline-none focus:shadow-outline py-3">Sign In</button>
    </form>
</template>
