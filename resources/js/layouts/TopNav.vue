            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <h1 class="text-white font-black">{{$page.app}}</h1>
                    </div>
        ...
        <div class="hidden md:hidden">
            ...
            <div class="pt-4 pb-3 border-t border-gray-700">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        <div class="text-base font-medium leading-none text-white">{{$page.auth.user.first_name}} {{$page.auth.user.last_name}}</div>
                        <div class="mt-1 text-sm font-medium leading-none text-gray-400">{{$page.auth.user.email}}</div>
                    </div>
                </div>
            </div>
        </div>
